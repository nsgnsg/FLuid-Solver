...
public:
	...
	void Solve(void);
	void changeMethodGauss();
	void changeMethodJacobi();
private:
	void DensStep(void);
	void VelStep(void);
	...
	void LinSolve2(int b, float * x, float * x0, float a, float c);
	//void LinSolve3(int b, float * x, float * x0, float a, float c);
